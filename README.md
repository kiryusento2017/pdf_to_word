...
├──────────────────────────────────────────────────────────────┤
│ ● 显卡 ✓ · Office ✓  历史 关于    选中 9 份 · 128 页 [开始转换]│ 状态栏
└──────────────────────────────────────────────────────────────┘
```
...
tests/      623 条 Python + 218 条前端检查 + 四个真实数据验证脚本
...
```
.venv\Scripts\python.exe -m unittest discover -s tests -q   # 623 条，37 秒
node tests\front_check.js                                   # 218 条，真渲染
```
