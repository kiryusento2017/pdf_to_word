...
**最新发行版**：[v0.2.1](https://github.com/kiryusento2017/pdf_to_word/releases/tag/v0.2.1)

---

## 给使用者

下载 `PDF2Word-Setup-v0.2.1.exe`（291 MB），双击 → 选文件夹 → 解压完成 →
双击里面的 `PDF转Word.exe`。
...
tests/      577 条 Python + 190 条前端检查 + 四个真实数据验证脚本
...
```
.venv\Scripts\python.exe -m unittest discover -s tests -q   # 577 条，16 秒
node tests\front_check.js                                   # 190 条，真渲染
```
